...
module.exports = {
  ...
  async getMinerVarDiff (minerEthAddress) {
    ...
    /* TODO: Automatic vardiff adjustment is broken. For now, this overrides all miners
             to poolconfig minimumShareDifficulty  */
    return this.getPoolMinimumShareDifficulty()
