  ...
  async broadcastQueuedMintTransactions () {
    ...
    if (hasQueuedTransaction && !hasPendingTransaction) {
      try {
        ...
        console.log(`broadcastQueuedMintTransactions: block:${nextQueuedTransactionData.blockNum} type:${nextQueuedTransactionData.txType} receipt:${nextQueuedTransactionData.receiptData}`)
