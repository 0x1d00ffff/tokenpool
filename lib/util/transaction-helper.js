...
module.exports = {
  ...
  async submitMiningSolutionOld (minerAddress, solution_number, challenge_digest, challenge_number, resending) {
    ...
    console.log('\n')
    console.log('submitMiningSolutionOld[DEPRECATED]: ---Submitting solution for reward---')
    console.log('submitMiningSolutionOld[DEPRECATED]: nonce ', solution_number)
    console.log('submitMiningSolutionOld[DEPRECATED]: challenge_number ', challenge_number)
    console.log('submitMiningSolutionOld[DEPRECATED]: challenge_digest ', challenge_digest)
    console.log('\n')
    ...
    try {
      var txCount = await this.web3.eth.getTransactionCount(addressFrom)
      console.log('submitMiningSolutionOld[DEPRECATED]: txCount', txCount)
    } catch (error) { // here goes if someAsyncPromise() rejected}
      console.log('submitMiningSolutionOld[DEPRECATED]: error', error)
    ...
    console.log('submitMiningSolutionOld[DEPRECATED]: estimatedGasCost', estimatedGasCost)
    console.log('submitMiningSolutionOld[DEPRECATED]: txData', txData)

    console.log('submitMiningSolutionOld[DEPRECATED]: addressFrom', addressFrom)
    console.log('submitMiningSolutionOld[DEPRECATED]: addressTo', addressTo)

    if (estimatedGasCost > max_gas_cost) {
      console.log('submitMiningSolutionOld[DEPRECATED]: Gas estimate too high!  Something went wrong ')
      return
    }
    ...
    return new Promise(function (result, error) {
      this.sendSignedRawTransaction(this.web3, txOptions, addressFrom, privateKey, function (err, res) {
        if (err) {
          console.log('submitMiningSolutionOld[DEPRECATED]: sendSignedRawTransaction error', err)
          error(err)
        }
        console.log('submitMiningSolutionOld[DEPRECATED]: sendSignedRawTransaction got tx result', res)
        result(res)
      })
    }.bind(this))
  },
  ...
  async broadcastPaymentBatches () {
    ...
    setTimeout(function () { self.broadcastPaymentBatches() }, 30 * 60 * 1000) // 30 minutes
